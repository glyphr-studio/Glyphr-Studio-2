		...
		<div class="content__page">
			<div class="content-page__left-area">
				...
				<div id="content-page__panel">
					...
					Email:<br>
					<a href="mailto:mail@glyphrstudio.com" target="_blank">mail@glyphrstudio.com</a>
					<br><br>
			...
			<div class="content-page__right-area">
				...
				<br>
				<p>
					Welcome to Alpha 1! What is an alpha? Currently, Glyphr Studio v2 does not
				...
				<p>
					...
					<label>This project was initially created with:</label> Version ${editor.project.projectSettings.initialVersion}</span>
				</p>
