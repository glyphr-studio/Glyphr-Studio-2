...
function makeHelpOverview() {
	const content = makeElement({
		...
		<br>
		<a href="https://www.glyphrstudio.com/help/tutorial">
		...
		<h3>About</h3>
			<span class="page__card__help-links">
				<a href="https://www.glyphrstudio.com/help/about/updates.html">
					Updates
				</a>
				<a href="https://www.glyphrstudio.com/help/about/features.html">
					Features
				</a>
				<a href="https://www.glyphrstudio.com/help/about/licensing.html">
					Licensing
				</a>
			</span>
		</div>
		...
		<div class="page__card">
			...
			<span class="page__card__help-links" style="grid-template-columns:1fr max-content; column-gap: 10px; padding-right: 10px;">
				<a href="https://www.glyphrstudio.com/help/getting-started/navigation.html">
					Navigation
				</a>
				<a href="https://www.glyphrstudio.com/help/getting-started/working-with-multiple-projects.html">
					Working with multiple projects
				</a>
				<a href="https://www.glyphrstudio.com/help/getting-started/editing.html">
					Editing
				</a>
				<a href="https://www.glyphrstudio.com/help/getting-started/keyboard-shortcuts.html">
					Keyboard shortcuts
				</a>
				<a href="https://www.glyphrstudio.com/help/getting-started/import-export.html">
					Import / Export
				</a>
			</span>
		</div>
		...
		<div class="page__card">
			<h3>FAQs</h3>
			<span class="page__card__help-links">
				<a href="https://www.glyphrstudio.com/help/faq/transparent-overlaps.html">
					Transparent overlaps
				</a>
				<a href="https://www.glyphrstudio.com/help/faq/curly-quotes.html">
					Curly quotes
				</a>
				<a href="https://www.glyphrstudio.com/help/faq/font-family.html">
					Font family
				</a>
				<a href="https://www.glyphrstudio.com/help/faq/run-locally.html">
					Run locally
				</a>
			</span>
		</div>
		...
		<div class="page__card">
			...
			<span class="page__card__help-links" style="grid-template-columns: repeat(3, 1fr);">
				<a href="https://www.glyphrstudio.com/help/pages/open-project.html">
					Open project
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/overview.html">
					Overview
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/characters.html">
					Characters
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/ligatures.html">
					Ligatures
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/components.html">
					Components
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/kerning.html">
					Kerning
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/live-preview.html">
					Live preview
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/global-actions.html">
					Global actions
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/settings.html">
					Settings
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/help.html">
					Help
				</a>
				<a href="https://www.glyphrstudio.com/help/pages/about.html">
					About
				</a>
			</span>
		</div>
...
export function makeKeyboardShortcutReference() {
	...
	makeOneRow(
		['Ctrl', 'Z'],
		`Undo the last action. If the previous action was on a different item, undo navigates to the previously changed item without undoing the change.`
	);
