        ...
        paths:[
          {objType:'Path',
            ...
            pathPoints:[
              ...
              {objType:'PathPoint', 'p':{objType: 'ControlPoint', coord:{objType:'Coord', x:400, y:0}}, 'h1':{objType: 'ControlPoint', coord:{objType:'Coord', x:400, y:0}}, 'h2':{objType: 'ControlPoint', coord:{objType:'Coord', x:400, y:0}}, 'type':'corner'}
            ]
          },
          {objType:'Path',
            ...
            {objType:'PathPoint', 'p':{objType: 'ControlPoint', coord:{objType:'Coord', x:197.1, y:265}}, 'h1':{objType: 'ControlPoint', coord:{objType:'Coord', x:197.1, y:265}}, 'h2':{objType: 'ControlPoint', coord:{objType:'Coord', x:197.1, y:265}}, 'type':'corner'}
            ]
          },
        ]
      },
        ...
        paths:[
          ...
          {objType:'Path',
            ...
            pathPoints:[
              ...
              {objType:'PathPoint', 'p':{objType: 'ControlPoint', coord:{objType:'Coord', x:140, y:645}}, 'h1':{objType: 'ControlPoint', coord:{objType:'Coord', x:140, y:645}}, 'h2':{objType: 'ControlPoint', coord:{objType:'Coord', x:140, y:645}}, 'type':'corner'}
            ]
          },
          {objType:'Path',
            ...
            pathPoints:[
              ...
              {objType:'PathPoint', 'p':{objType: 'ControlPoint', coord:{objType:'Coord', x:140, y:327}}, 'h1':{objType: 'ControlPoint', coord:{objType:'Coord', x:140, y:327}}, 'h2':{objType: 'ControlPoint', coord:{objType:'Coord', x:140, y:327}}, 'type':'corner'}
            ]
          },
        ]
      },
        ...
        paths:[
          {objType:'Path',
            pathPoints:[
              ...
              {objType:'PathPoint', 'p':{objType: 'ControlPoint', coord:{objType:'Coord', x:400, y:540}}, 'h1':{objType: 'ControlPoint', coord:{objType:'Coord', x:400, y:540}}, 'h2':{objType: 'ControlPoint', coord:{objType:'Coord', x:400, y:540}}, 'type':'corner'}
            ]
          }
        ]
      }
