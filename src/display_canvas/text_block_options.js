...
export class TextBlockOptions {
	...
	save() {
		...
		if (this.text === samples.swadesh_207_short) result.text = '{{swadesh_207_short}}';
		if (this.text === samples.swadesh_207_frequent) result.text = '{{swadesh_207_frequent}}';
		if (this.text === samples.english_10_short) result.text = '{{english_10_short}}';
		if (this.text === samples.english_10_frequent) result.text = '{{english_10_frequent}}';
		if (this.text === samples.english_50_short) result.text = '{{english_50_short}}';
