...
describe('makeGlyphSVGforExport', () => {
	...
	<g>
		<path d="M0,0M0,15 C0,15,10,15,10,15 C10,15,10,5,10,5 C10,5,0,5,0,5 C0,5,0,15,0,15Z M5,10 C5,10,15,10,15,10 C15,10,15,0,15,0 C15,0,5,0,5,0 C5,0,5,10,5,10Z "/>
	</g>
</svg>`);
	});
});