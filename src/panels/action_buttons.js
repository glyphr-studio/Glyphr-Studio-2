...
const icon = {
	...
	componentGreen: accentColors.green.l65,
	...
	combineFill: accentColors.gray.l70,
};

const overlay = {
	delete: `
		<g data-name="Overlay Delete">
			<path d="M11.978,10.619c-.664-.885-2.644.13-1.484,1.484,2.968,3.462,7.419,7.419,8.903,7.419,0-.989-4.452-4.946-7.419-8.903Z" fill="${icon.dangerRed}"/>
			<path d="M17.914,10.619c1.104-.859,2.603.644,1.484,1.484-5.935,4.452-6.925,7.419-9.398,7.914.967-1.983,3.462-5.935,7.914-9.398Z" fill="${icon.dangerRed}"/>
		</g>`,
	add: `
		<g data-name="Overlay Add">
			<rect x="14" y="10" width="2" height="10" fill="${icon.actionBlue}"/>
			<rect x="10" y="14" width="10" height="2" fill="${icon.actionBlue}"/>
		</g>`,
};
...
makeActionButtonIcon.paste = () => {
	const re = `
		<g id="d" data-name="Clipboard">
			<g>
				<rect x="3.5" y="4.5" width="13" height="15" fill="${icon.lightGray}"/>
				<path d="M16,5v14H4V5h12M17,4H3v16h14V4h0Z" fill="${icon.actionBlue}"/>
			</g>
			<g>
				<path d="M6.5,5.5v-3h1v-.5c0-.901,1.505-1.5,2.5-1.5s2.5.599,2.5,1.5v.5h1v3h-7Z" fill="${icon.lightGray}"/>
				<path d="M10,1c.836,0,2,.504,2,1v1h1v2h-6v-2h1v-1c0-.496,1.164-1,2-1M10,0c-1.105,0-3,.667-3,2h-1v4h8V2h-1c0-1.333-1.895-2-3-2h0Z" fill="${icon.actionBlue}"/>
			</g>
		</g>
	`;
...
makeActionButtonIcon.pastePathsFromAnotherGlyph = () => {
	const re = `
		...
		<g data-name="Get Shapes">
			<path d="M13.26,16l-2.548-7h.787v-1h-3v1h.787l-2.548,7h-1.24v1h3v-1h-.696l.728-2h2.937l.728,2h-.696v1h3v-1h-1.24ZM8.896,13l1.104-3.034,1.104,3.034h-2.209Z" fill="${icon.actionBlue}"/>
		</g>
	`;
...
makeActionButtonIcon.pastePathsFromAnotherProject = () => {
	const re = `
		<g id="d" data-name="Paste from other project">
			<g>
...
makeActionButtonIcon.addShape = function (isComponentInstance = false) {
	...
	const re = `
		<g data-name="Shape">
			<rect x="0.5" y="0.5" width="11" height="11" fill="${icon.lightGray}" style="stroke: ${accent}; stroke-width: 1px"/>
		</g>
		${overlay.add}
	`;
...
makeActionButtonIcon.undo = () => {
	const re = `
		<g id="d" data-name="Undo">
			<path d="M11.57,17.559c3.981-4.076,5.808-8.73,4.98-11.283-.378-1.168-1.278-1.812-2.534-1.812-1.636,0-3.766,1.064-6.333,3.165l-.351.287,1.792,2.685-8.467.847L3.211,1.234l1.66,2.49.421-.302C7.95,1.511,10.639.5,13.066.5c3.236,0,5.725,1.856,6.34,4.729.703,3.278-1.076,8.189-7.836,12.331Z" fill="${icon.lightGray}"/>
			<path d="M13.065,0v1c2.992,0,5.289,1.702,5.853,4.334.541,2.526-.498,6.084-4.398,9.473,2.312-3.343,3.173-6.63,2.506-8.686-.444-1.37-1.541-2.156-3.009-2.156h0c-1.754,0-3.991,1.103-6.649,3.278l-.702.575.504.755,1.078,1.615-6.932.693L3.422,2.452l.746,1.119.575.862.841-.605c2.573-1.85,5.16-2.828,7.481-2.828V0M13.066,0c-2.342,0-5.115.893-8.066,3.016L3,.016,0,12.016l10.003-1-2.003-3c2.638-2.158,4.644-3.051,6.016-3.052,4.35,0,2.336,8.97-6.059,15.052C24.568,12.55,21.842.001,13.066,0h0Z" fill="${icon.actionBlue}"/>
		</g>
	`;
...
makeActionButtonIcon.linkToGlyph = () => {
	const re = `
		<g id="d" data-name="Link Component">
			<g>
				<path d="M11.521,5.653l-5.869,5.869c-.324.324-.849.324-1.174,0s-.324-.85,0-1.174l5.869-5.869c.324-.324.849-.324,1.174,0s.324.85,0,1.174Z" fill="${icon.componentGreen}"/><path d="M11.521,5.653l-5.869,5.869c-.324.324-.849.324-1.174,0s-.324-.85,0-1.174l5.869-5.869c.324-.324.849-.324,1.174,0s.324.85,0,1.174Z" fill="${icon.componentGreen}"/>
				<path d="M4.783,13.565c-.712.712-1.781,1.165-2.647.299s-.413-1.935.299-2.647l3.804-3.804c-1.152-.289-2.439.091-3.5,1.153l-1.478,1.478c-1.561,1.561-1.686,3.616-.304,4.999,1.382,1.382,3.438,1.257,4.999-.304l1.478-1.478c1.062-1.062,1.442-2.349,1.153-3.5l-3.804,3.804Z" fill="${icon.componentGreen}"/><path d="M11.521,5.653l-5.869,5.869c-.324.324-.849.324-1.174,0s-.324-.85,0-1.174l5.869-5.869c.324-.324.849-.324,1.174,0s.324.85,0,1.174Z" fill="${icon.componentGreen}"/>
				<path d="M13.565,4.783c.712-.712,1.165-1.781.299-2.647s-1.935-.413-2.647.299l-3.804,3.804c-.289-1.152.091-2.439,1.153-3.5l1.478-1.478c1.561-1.561,3.616-1.686,4.999-.304s1.257,3.438-.304,4.999l-1.478,1.478c-1.062,1.062-2.349,1.442-3.5,1.153l3.804-3.804Z" fill="${icon.componentGreen}"/><path d="M11.521,5.653l-5.869,5.869c-.324.324-.849.324-1.174,0s-.324-.85,0-1.174l5.869-5.869c.324-.324.849-.324,1.174,0s.324.85,0,1.174Z" fill="${icon.componentGreen}"/>
			</g>
		</g>
		${overlay.add}
	`;
...
makeActionButtonIcon.round = () => {
	let re = `
		<g data-name="Round">
			...
			<g>
				<path d="M8.212,7.214c-.407-.542-1.62.08-.909.909,1.818,2.121,4.545,4.545,5.455,4.545,0-.606-2.727-3.03-4.545-5.455Z" fill="${icon.dangerRed}"/>
				<path d="M11.849,7.214c.677-.526,1.595.395.909.909-3.636,2.727-4.242,4.545-5.758,4.849.593-1.215,2.121-3.636,4.849-5.758Z" fill="${icon.dangerRed}"/>
			</g>
			<g>
				<path d="M15.212,7.214c-.407-.542-1.62.08-.909.909,1.818,2.121,4.545,4.545,5.455,4.545,0-.606-2.727-3.03-4.545-5.455Z" fill="${icon.dangerRed}"/>
				<path d="M18.849,7.214c.677-.526,1.595.395.909.909-3.636,2.727-4.242,4.545-5.758,4.849.593-1.215,2.121-3.636,4.849-5.758Z" fill="${icon.dangerRed}"/>
			</g>
		</g>
	`;
...
makeActionButtonIcon.flipVertical = () => {
	const re = `
		<g data-name="Flip Vertical">
			...
			<g>
				<polygon points=".5 19.516 .5 15.223 4.207 11.516 19.5 11.516 19.5 13.733 9.861 19.516 .5 19.516" fill="${icon.actionBlue}"/>
				<path d="M19,12v1.434l-9.277,5.566H1v-3.586l3.414-3.414h14.586M20,11H4L0,15v5h10l10-6v-3h0Z" fill="${icon.darkGray}"/>
			</g>
		</g>
	`;
...
makeActionButtonIcon.flipHorizontal = () => {
	const re = `
		<g id="d" data-name="Flip Horizontal">
			<g>
			...
			<g>
				<polygon points="15.207 19.5 11.5 15.793 11.5 .5 13.717 .5 19.5 10.139 19.5 19.5 15.207 19.5" fill="${icon.actionBlue}"/>
				<path d="M13.434,1l5.566,9.277v8.723h-3.586l-3.414-3.414V1h1.434M14,0h-3v16l4,4h5v-10L14,0h0Z" fill="${icon.darkGray}"/>
			</g>
		</g>
	`;
...
makeActionButtonIcon.importGlyphSVG = () => {
	let re = `
		<g id="d" data-name="SVG Import">
			<polygon points="20 2 18 0 14 4 12 2 12 8 18 8 16 6 20 2" fill="${icon.actionBlue}"/>
			<g>
...
makeActionButtonIcon.deleteGlyph = () => {
	let re = `
		<g id="d" data-name="Glyph">
			<path d="M18.521,17L13.426,3h1.574V0H5v3h1.574L1.479,17H0v3h7v-3h-2.329l1.456-4h7.746l1.456,4h-2.329v3h7v-3h-1.479ZM7.219,10l2.548-7h.467l2.548,7h-5.562Z" fill="${icon.lightGray}"/>
		</g>
		${overlay.delete}
	`;
...
makeActionButtonIcon.switchPathComponent = function (isComponentInstance = false) {
	...
	let afterFill = icon.componentGreen;
	if (isComponentInstance) {
		beforeFill = icon.componentGreen;
	...
	const re = `
		<g data-name="Switch Shape Component">
			<g>
				...
				<path d="M2.485,1l4.515,6.32v6.68h-3.586l-2.414-2.414V1h1.485M3,H0v12l3,3h5V7L3,h0Z" fill="${beforeFill}"/>
			</g>
			<g>
				<polygon points="14.207 19.516 10.5 15.809 10.5 .516 13.732 .516 19.5 9.168 19.5 19.516 14.207 19.516" fill="${icon.darkGray}"/>
				<path d="M13.465,1l5.535,8.303v9.697h-4.586l-3.414-3.414V1h2.465M14,h-4v16l4,4h6v-11L14,h0Z" fill="${afterFill}"/>
			</g>
		</g>
	`;
...
makeActionButtonIcon.delete = () => {
	const re = `
		<g data-name="Big delete">
			<path d="M4,1c-1.342-1.789-5.346.262-3,3,6,7,15,15,18,15,0-2-9-10-15-18Z" fill="${icon.dangerRed}"/>
			<path d="M16,1c2.233-1.736,5.263,1.303,3,3C7,13,5,19,0,20,1.955,16.007,7,8,16,1Z" fill="${icon.dangerRed}"/>
		</g>
	`;
...
makeActionButtonIcon.findSingleLetterPair = () => {
	const re = `
		...
		<g id="d" data-name="Overlay Find">
			<g>
				<circle cx="14" cy="14" r="3.1" fill="${icon.lightGray}"/>
				<path d="M14,11.8c1.213,0,2.2.987,2.2,2.2s-.987,2.2-2.2,2.2-2.2-.987-2.2-2.2.987-2.2,2.2-2.2M14,10c-2.209,0-4,1.791-4,4s1.791,4,4,4,4-1.791,4-4-1.791-4-4-4h0Z" fill="${icon.actionBlue}"/>
			</g>
			<line x1="19.2" y1="19.2" x2="16" y2="16" style="stroke: ${icon.actionBlue}; stroke-width: 1.8px;"/>
		</g>
	`;
...
makeActionButtonIcon.moveLayerDown = () => {
	const re = `
		<g id="d" data-name="Layer Down">
			...
			<polygon points="10 12.236 2.764 8.618 0 10 10 15 20 10 17.236 8.618 10 12.236" fill="${icon.actionBlue}"/>
		</g>
	`;
...
makeActionButtonIcon.moveLayerUp = () => {
	const re = `
		<g id="d" data-name="Layer Up">
			<path d="M19,16.999l-3-2.999s-3.047,3.047-3,2.999h1.999v3.001h2v-3h2Z" fill="${icon.actionBlue}"/>
			<polygon points="10 10 0 5 10 0 20 5 10 10" fill="${icon.actionBlue}"/>
...
makeActionButtonIcon.resetPathPoint = () => {
	const re = `
		...
		<g data-name="PathPoint">
			<line x1="3" y1="15" x2="15" y2="3" style="fill: none; stroke: ${icon.actionBlue};"/>
			<rect x="6.5" y="6.516" width="5" height="5" fill="${icon.lightGray}"/>
			<path d="M11,7v4h-4v-4h4M12,6h-6v6h6v-6h0Z" fill="${icon.actionBlue}"/>
			<circle cx="16" cy="2" r="2" fill="${icon.actionBlue}"/>
			<circle cx="2" cy="16" r="2" fill="${icon.actionBlue}"/>
		</g>
	`;
...
makeActionButtonIcon.mergePathPoints = () => {
	const re = `
		<g id="d" data-name="Merge Points">
			<g>
				<line x1="6" y1="18" x2="6.447" y2="17.106" style="fill: none; stroke: ${icon.actionBlue}; stroke-width: 2px;"/>
				<line x1="6.891" y1="16.217" x2="13.331" y2="3.339" style="fill: none; stroke: ${icon.actionBlue}; stroke-dasharray: 2 1; stroke-width: 2px;"/>
				<line x1="13.553" y1="2.894" x2="14" y2="2" style="fill: none; stroke: ${icon.actionBlue}; stroke-width: 2px;"/>
			</g>
