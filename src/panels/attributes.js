...
function makeAttributesGroup_shape(s) {
	...
	content +=
	  ...
	  (s.xLock
		? 'disabled="disabled"'
		: "onchange="_UI.focusElement=this.id; if(!_UI.redrawing){_UI.multiSelect.shapes.setShapePosition(this.value, false); historyPut('Shape X Position : '+this.value); redraw({calledBy:'makeAttributesGroup_shape - X Position'});}\"
		value="${xval +
	  '" >' +
	  '</div>' +
	  dimSplit() +
	  ...
	  (s.yLock
		? 'disabled="disabled"'
		: "onchange="_UI.focusElement=this.id; if(!_UI.redrawing){_UI.multiSelect.shapes.setShapePosition(false, this.value); historyPut('Shape Y Position : '+this.value); redraw({calledBy:'makeAttributesGroup_shape - Y Position'});}\"
		value="${yval +
	  '" >' +
	  '</div>' +
	  '</td>' +
	...
	content +=
	  ...
	  (s.wLock
		...
		: 'onchange="_UI.focusElement=this.id; if(!_UI.redrawing){_UI.multiSelect.shapes.setShapeSize(this.value,false,' +
		  s.ratioLock +
		  "); historyPut('Shape Width : '+this.value); redraw({calledBy:'makeAttributesGroup_shape - Width'});}\"") +
		value="${wval +
	  '" >' +
	  '</div>' +
	  dimSplit() +
	  ...
	  (s.hLock
		...
		: 'onchange="_UI.focusElement=this.id; if(!_UI.redrawing){_UI.multiSelect.shapes.setShapeSize(false,this.value,' +
		  s.ratioLock +
		  "); historyPut('Shape Height : '+this.value); redraw({calledBy:'makeAttributesGroup_shape - Height'});}\"") +
		value="${hval +
	  '" ></td>' +
	  '</div>' +
	  '</td>' +
	...
	*/
	...
	content +=
	  ...
	  '<td> overlap mode </td>' +
	  '<td>' +
	  '<button style="width:180px; height:26px; padding:0px;" onclick="_UI.multiSelect.shapes.reverseWinding();historyPut(\'Reverse Path Direction\');redraw({calledBy:\'makeAttributesGroup_shape - Winding\'});">' +
...
function makeAttributesGroup_pathPoint(tp) {
	...
	content +=
	  ...
	  '" onchange="_UI.focusElement=this.id; _UI.multiSelect.points.getSingleton().parent.selectPathPoint(this.value); redraw({calledBy:\'makeAttributesGroup_pathPoint\'});"></td>' +
	  '</tr>';
	...
	content +=
	  ...
	  (tp.p.xLock
		? 'disabled="disabled"'
		: "onchange="_UI.focusElement=this.id; _UI.multiSelect.points.getSingleton().setPathPointPosition('p', (this.value), 'null'); historyPut('Point X Position : '+this.value); redraw({calledBy:'makeAttributesGroup_pathPoint'});\"
	  ...
	  (tp.p.yLock
		? 'disabled="disabled"'
		: "onchange="_UI.focusElement=this.id; _UI.multiSelect.points.getSingleton().setPathPointPosition('p', 'null', (this.value)); historyPut('Point Y Position : '+this.value); redraw({calledBy:'makeAttributesGroup_pathPoint'});\"
	...
	if (tp.h1.use) {
	  content +=
		...
		(tp.h1.xLock
		  ? 'disabled="disabled"'
		  : "onchange="_UI.focusElement=this.id; _UI.multiSelect.points.getSingleton().setPathPointPosition('h1', (this.value), 'null'); historyPut('h1 X Position : '+round(this.value)); redraw({calledBy:'makeAttributesGroup_pathPoint'});\"
		...
		(tp.h1.yLock
		  ? 'disabled="disabled"'
		  : "onchange="_UI.focusElement=this.id; _UI.multiSelect.points.getSingleton().setPathPointPosition('h1', 'null', (this.value)); historyPut('h1 Y Position : '+round(this.value)); redraw({calledBy:'makeAttributesGroup_pathPoint'});\"
	...
	if (tp.h2.use) {
	  content +=
		...
		(tp.h2.xLock
		  ? 'disabled="disabled"'
		  : "onchange="_UI.focusElement=this.id; _UI.multiSelect.points.getSingleton().setPathPointPosition('h2', (this.value), 'null'); historyPut('h2 X Position : '+round(this.value)); redraw({calledBy:'makeAttributesGroup_pathPoint'});\"
		...
		(tp.h2.yLock
		  ? 'disabled="disabled"'
		  : "onchange="_UI.focusElement=this.id; _UI.multiSelect.points.getSingleton().setPathPointPosition('h2', 'null', (this.value)); historyPut('h2 Y Position : '+round(this.value)); redraw({calledBy:'makeAttributesGroup_pathPoint'});\"
