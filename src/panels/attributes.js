...
function makeAttributesGroup_shape(s) {
	...
	content +=
	  ...
	  // lockUI('_UI.multiSelect.shapessingleton.xLock', s.xLock, 'ssxlock') +
	  ...
	  dimSplit() +
	  '<div class="lockwrapper">' +
	  // lockUI('_UI.multiSelect.shapessingleton.yLock', s.yLock, 'ssylock') +
	...
	content +=
	  ...
	  '<td>' +
	  '<div class="lockwrapper">' +
	  // lockUI('_UI.multiSelect.shapessingleton.wLock', s.wLock, 'sswlock') +
	  ...
	  dimSplit() +
	  '<div class="lockwrapper">' +
	  // lockUI('_UI.multiSelect.shapessingleton.hLock', s.hLock, 'sshlock') +
