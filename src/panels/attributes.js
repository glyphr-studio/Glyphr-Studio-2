...
export { makeInputs_position, makeInputs_size, makeAttributesGroup_pathPoint, makeAttributesGroup_path };
...
//	-------------------------------------------
function makeAttributesGroup_path(path) {
	// log("makeAttributesGroup_path - Drawing Path Details");
