	 ...
	 */
	export function drawPoint(ctx, isSelected, accent = '#000', pointSize = 7) {
	 ...
	 * @param {number} pointSize - how big to draw the point
	 */
	export function drawDirectionalityPoint(
		ctx,
		isSelected,
		accent = '#000',
		next,
	 ...
	 * @param {number} pointSize - how big to draw the point
	 */
	export function drawHandles(ctx, drawH1, drawH2, accent = '#000', pointSize = 7) {
		ctx.fillStyle = accent;
		ctx.strokeStyle = accent;
		ctx.lineWidth = 1;
		ctx.font = '10px Consolas';
