...
function componentInstanceDetails(s) {
  ...
  content +=
    ...
    '<td>' +
    checkUI('_UI.multiSelect.shapes.getSingleton().flipEW', s.flipEW, true) +
    '</td>' +
    '</tr>';
  ...
  content +=
    ...
    '<td> flip vertical </td>' +
    '<td>' +
    checkUI('_UI.multiSelect.shapes.getSingleton().flipNS', s.flipNS, true) +
    '</td>' +
    '</tr>';
  ...
  content +=
    ...
    '<td>' +
    checkUI(
      '_UI.multiSelect.shapes.getSingleton().reverseWinding',
      s.reverseWinding,
      true
    ) +
    '</td>' +
  ...
  rotationhelp +=
    '<br><br>This option changes how this Component Instances is rendered.  Default is re-size, then rotate. When checked, it will be rotate, then re-size. This order has an impact on the Component Instance’s resulting shape.';
  rotationhelp +=
  ...
  content +=
    ...
    '<td>' +
    checkUI(
      '_UI.multiSelect.shapes.getSingleton().rotateFirst',
      s.rotateFirst,
      true
    ) +
    '&ensp;' +
