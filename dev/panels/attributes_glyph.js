...
**/
 ...
 content += pointDetails(_UI.multiSelect.points.getSingleton());
    ...
    function shapeDetails(s) {
        ...
        let overlaphelptext = '<h1>Overlap Mode</h1><div style=\\&apos;width:500px;\\&apos;>'+
    ...
    function pointDetails(tp) {
        ...
        content += '<tr>'+
            ...
            '<td><input type="number" id="pointnum" class="lockpad" value="' + _UI.multiSelect.points.getSingletonPointNumber() + '" onchange="_UI.focusElement=this.id; _UI.multiSelect.points.getSingleton().parent.selectPathPoint(this.value); redraw({calledBy:\'pointDetails\'});"></td>'+
        '</tr>';
    ...
    function dimSplit() {
 return '<span style="color:'+_UI.colors.gray.l60+'; width:20px; height:24px; text-align:center; display:inline-block; font-size:1.4em; vertical-align:-2px;">&#x2044;</span>';
}
