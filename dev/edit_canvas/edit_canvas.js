...
//-------------------
    ...
    function setView(oa){
        ...
        var sc = (_UI.currentPage === 'kerning')? getSelectedKernID() : getSelectedWorkItemID();
        var v = _UI.views;
...
//-------------------
    ...
    function drawGuides() {
        ...
        var ps = _GP.projectsettings;
        var onglyphedit = (_UI.currentPage === 'glyph edit' || _UI.currentPage === 'ligatures');
        var onkern = (_UI.currentPage === 'kerning');
        // debug('\t ps.guides: ');
        // debug(ps.guides);
