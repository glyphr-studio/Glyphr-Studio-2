...
export default class PageOpenProject {
  ...
  pageLoader() {
    ...
    const tableRight = content.querySelector('#openProjectTableRight');
    ...
    const tableLeft = content.querySelector('#openProjectTableLeft');
  ...
  handleDragOver(evt) {
    ...
    const dropZone = document.getElementById('openProjectTableRight');
