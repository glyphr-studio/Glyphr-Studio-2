...
function makeFloatLogo() {
  return (
    '<div id="toolsarea_lowerright">' +
    makeGlyphrStudioLogo({ fill: _UI.colors.blue.l55 }) +
    '</div>'
  );
}
  ...
  function hamburgerStep() {
    ...
    if (con)
      con.innerHTML = makeIcon({
        name: 'button_npNav',
        color: _UI.colors.blue.l85,
        hoverColor: _UI.colors.blue.l85,
      });
...
_UI.icons.nav_fontsettings =
  ...
  '<path d="M17.8,32.8l3.7-15.6h-2l0.6-2.4h14.5l-1.5,6.1h-2.4l0.9-3.8h-7.2L23,23.4h6.1l-0.6,2.4h-6.1l-1.7,7h2.2  l-0.6,2.4h-7l0.6-2.4H17.8z"/>';

_UI.icons.nav_globalactions =
